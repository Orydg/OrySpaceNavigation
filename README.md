...
```
* при помощь IDE среды (например PyCharm https://www.jetbrains.com/pycharm/download/#section=windows) открыть файл osn.py
...
* клавиша "F12" - скрывает/отображает меню
